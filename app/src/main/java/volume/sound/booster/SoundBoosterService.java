...
public class SoundBoosterService extends Service {
    ...
    private static void setNextUpdate() {
        try {
            PendingIntent pendingIntent = PendingIntent.getService(context.getApplicationContext(), 0, new Intent(context.getApplicationContext(), SoundBoosterService.class), 0);
